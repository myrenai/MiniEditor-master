...
import fr.istic.m1.aco.miniediteur.v3.factory.CommandType;
...
public abstract class BaseIHM  implements Invoker, Observer{
	...
	protected boolean enregistrementMode;
	...
	protected boolean undoFlag;
	protected boolean redoFlag;
	...
	/////////////////////// V3 //////////////////////////////////
	protected void undo(){
		invoke(commandFactory.getCommand(CommandType.UNDO));
	}
	protected void redo(){
		invoke(commandFactory.getCommand(CommandType.REDO));
	}
	protected void reset(){
		invoke(commandFactory.getCommand(CommandType.RESET));
	}
